    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            sx={{ fontSize: "16px", color: "white", mt: "10px" }}
      ...
      <div className="mt-6 ">
        <Box
          className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3  pl-[13px]"
          sx={{
            mt: { xs: "37px", lg: "37px" },
            gap: { xs: "20px", lg: "160px" },
          }}
        >
          {products.map((product) => (
            <div
              key={product.id}
              className="p-3 bg-white w-[81vw] sm:w-[50vw] md:w-[108%] lg:w-[159%] xl:w-[149%] 2xl:w-[136%]"
              style={{
                borderRadius: "14px",
                boxShadow: "6px 6px 54px rgba(0, 0, 0, 0.1)",
              }}
            >
              ...
              >
                <Box sx={{ display: "flex", justifyContent: "space-between",width:"100%" }}>
                  <h3 className="mt-2 text-lg font-bold text-nowrap">
                    {product.name}
                  </h3>
                  <img src={heartimg} />
                </Box>
                <p className="text-[15px] font-[700] text-[#4880ff]">
                  {product.price}
                </p>
                ...
                <button
                  className=" px-[20px] py-[10px] mt-[25px] mb-[20px] text-[14px] "
                  style={{
